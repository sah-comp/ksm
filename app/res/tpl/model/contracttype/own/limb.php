    ...
    <div class="row">
        ...
        <div class="span1">
            <input
                ...
                value="0" />
            <input
                id="contracttype-<?php echo $record->getId() ?>-limb-<?php echo $_limb->getId() ?>-active"
                type="checkbox"
                name="dialog[ownLimb][<?php echo $index ?>][active]"
        ...
        <div class="span1">
            <input
                ...
                min="0"
                step="10"
                id="contracttype-<?php echo $record->getId() ?>-limb-<?php echo $_limb->getId() ?>-sequence"
        ...
        <div class="span2">
            <input
                type="text"
                id="contracttype-<?php echo $record->getId() ?>-limb-<?php echo $_limb->getId() ?>-name"
                name="dialog[ownLimb][<?php echo $index ?>][name]"
                value="<?php echo htmlspecialchars($_limb->name) ?>" />
        </div>
        <div class="span2">
            <select
                id="contracttype-<?php echo $record->getId() ?>-limb-<?php echo $_limb->getId() ?>-kind"
        ...
        <div class="span2">
            <select
                id="contracttype-<?php echo $record->getId() ?>-limb-<?php echo $_limb->getId() ?>-tag"
        ...
        <div class="span1">
            <input
                ...
                value="0" />
            <input
                id="contracttype-<?php echo $record->getId() ?>-limb-<?php echo $_limb->getId() ?>-filter"
                type="checkbox"
                name="dialog[ownLimb][<?php echo $index ?>][filter]"

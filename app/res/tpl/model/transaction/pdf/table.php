<?php $_colspan_lft = 5?>
<?php $_colspan_rtg = 2?>
<table class="position notsticky" width="100%">
    <thead>
        <tr>
        ...
        <tr class="<?php echo $_position->isAlternative() ? 'alternative ' : '' ?><?php echo $_position->kindAsCss() ?>">
            <?php
                ...
                ?>
                    ...
                    <td class="number cushion-right"><?php echo htmlspecialchars($_position->fancyNumber('count')) ?></td>
                    <td><?php echo htmlspecialchars($_position->unit->name) ?></td>
